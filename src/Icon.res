module Settings = {
  @react.component
  let make = (~color, ~height: string) => {
    Js.log("IconSettings render")
    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" height width=height fill=color>
      <g id="icons">
        <path
...
module Cancel = {
  ...
  let make = (~color, ~height: string) => {
    ...
    <svg height viewBox="0 0 32 32" width=height xmlns="http://www.w3.org/2000/svg" fill=color>
      <rect fill="none" height width=height />
      <polygon
        fill=color points="2,26 6,30 16,20 26,30 30,26 20,16 30,6 26,2 16,12 6,2 2,6 12,16"
      />
    </svg>
  }
}
...
module ClearAllInfo = {
  @react.component
  let make = (~color, ~height: string) =>
    <svg height viewBox="0 0 16 16" width=height xmlns="http://www.w3.org/2000/svg" fill=color>
...
module Voices = {
  @react.component
  let make = (~color, ~height: string) =>
    <svg xmlns="http://www.w3.org/2000/svg" width=height height viewBox="0 0 24 24" fill=color>
